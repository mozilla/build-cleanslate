...
PS_FILE_DEFAULT = '/var/tmp/cleanslate'
...
def save_process_list(process_list, filename=PS_FILE_DEFAULT):
    '''
...
def get_saved_process_list(filename=PS_FILE_DEFAULT):
    '''
...
def clean_process_list(for_user, filename=PS_FILE_DEFAULT, snapshot=False, dryrun=False):
    '''
...
def make_argparser():
    ...
    parser.add_argument('-f', '--filename', default=PS_FILE_DEFAULT, help='Location of saved process lists.')
